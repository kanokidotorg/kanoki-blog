...
#### Pandas is an open source data analysis library in Python and it is extensively used for Data analysis, Data munging and Cleaning. Pandas has a high performing and user friendly data structures.[¶](#Pandas-is-an-open-source-data-analysis-library-in-Python-and-it-is-extensively-used-for-Data-analysis,-Data-munging-and-Cleaning.-Pandas-has-a-high-performing-and-user-friendly-data-structures.)
...
#### Pandas has two types of data structures:[¶](#Pandas-has-two-types-of-data-structures:)

#### a) Series - it's a one dimensional array with indexes, it stores a single column or row of data in a Dataframe

#### b) Dataframe - it's a tabular spreadsheet like structure representing rows each of which contains one or multiple columns[¶](#b)-Dataframe---it's-a-tabular-spreadsheet-like-structure-representing-rows-each-of-which-contains-one-or-multiple-columns)

#### First, Let's do some import[¶](#First,-Let's-do-some-import)
